    ...
    >
      <Box className={styles.content}>
        ...
        <Typography component='h5' className={`${styles.subHeading} dark-blue`}>
          <br />
          This web site is operated and owned by the DataYaan Solutions Private Limited.
          Throughout the site, the terms “we”, “us” and “our” refer to DataYaan. DataYaan
          offers this website, including all information, tools and services available
          from this site to you, the user, conditioned upon your acceptance of all terms,
          conditions, policies and notices stated here.
          <br />
          <br /> By visiting our site and/ or purchasing something from us, you engage in
        ...
        <Typography component='h4' className={`${styles.heading} dark-blue`}>
          ONLINE WEB AND MOBILE APP TERMS
        </Typography>
        <Typography component='h5' className={`${styles.subHeading} dark-blue`}>
          <br />
          ...
          <br />
          <br /> You must not transmit any worms or viruses or any code of a destructive
          nature.
          <br />
        ...
        <Typography component='h5' className={`${styles.subHeading} dark-blue`}>
          ...
          over networks.
          <br />
          <br /> You agree not to reproduce, duplicate, copy, sell, resell or exploit any
          ...
          <br />
          <br /> The headings used in this agreement are included for convenience only and
        ...
        <Typography component='h5' className={`${styles.subHeading} dark-blue`}>
          ...
          <br />
          <br /> We reserve the right at any time to modify or discontinue the Service (or
          any part or content thereof) without notice at any time.
          <br />
          <br /> We shall not be liable to you or to any third-party for any modification,
        ...
        <Typography component='h5' className={`${styles.subHeading} dark-blue`}>
          ...
          to return or exchange only according to our Return Policy. We have made every
          ...
          <br />
          <br /> We reserve the right, but are not obligated, to limit the sales of our
        ...
        <Typography component='h5' className={`${styles.subHeading} dark-blue`}>
          ...
          <br />
          <br /> You agree to provide current, complete and accurate purchase and account
        ...
        <Typography component='h5' className={`${styles.subHeading} dark-blue`}>
          ...
          <br />
          <br /> You acknowledge and agree that we provide access to such tools ”as is”
          ...
          <br />
          <br /> Any use by you of optional tools offered through the site is entirely at
          ...
          provider(s).
          <br />
          <br /> We may also, in the future, offer new services and/or features through
        ...
        <Typography component='h5' className={`${styles.subHeading} dark-blue`}>
          ...
          <br />
          <br /> Third-party links on this site may direct you to third-party websites
          ...
          <br />
          <br /> We are not liable for any harm or damages related to the purchase or use
        ...
        <Typography component='h5' className={`${styles.subHeading} dark-blue`}>
          ...
          <br />
          <br /> We undertake no obligation to update, amend or clarify information in the
        ...
        <Typography component='h5' className={`${styles.subHeading} dark-blue`}>
          ...
          <br />
          <br /> We do not warrant that the results that may be obtained from the use of
          the service will be accurate or reliable. You agree that from time to time we
          may remove the service for indefinite periods of time or cancel the service at
          any time, without notice to you.
          <br />
          <br /> You expressly agree that your use of, or inability to use, the service is
          ...
          <br />
          <br /> In no case shall DataYaan, our directors, officers, employees,
        ...
        <Typography component='h5' className={`${styles.subHeading} dark-blue`}>
          <br />
          You agree to indemnify, defend and hold harmless DataYaan and our parent,
        ...
        <Typography component='h5' className={`${styles.subHeading} dark-blue`}>
          ...
          <br /> If in our sole judgment you fail, or we suspect that you have failed, to
        ...
        <Typography component='h5' className={`${styles.subHeading} dark-blue`}>
          ...
          <br />
          <br /> These Terms of Service and any policies or operating rules posted by us
          ...
          <br />
          <br /> Any ambiguities in the interpretation of these Terms of Service shall not
        ...
        <Typography component='h5' className={`${styles.subHeading} dark-blue`}>
          ...
          replace any part of these Terms of Service by posting updates and changes to our
