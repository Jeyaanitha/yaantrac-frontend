...
import { getIdleReport } from '../report-utils/services/ReportFunctions';
...
const IdleReport = () => {
  ...
  const handleMapView = row => {
    ...
    let info = [
      ...
      `End Date : ${endDate}`,
      `Idle Start Time : ${idleStart}`,
      `Idle End Time : ${idleEnd}`,
